    ...
    return (
        <div className='my-10'>
            ...
            <div>
                 ...
                 <p className='text-2xl p-5'>Ans: useState lets you use local state within a function component. You pass the initial state to this function and it returns a variable with the current state value <br/> (not necessarily the initial state) and another function to update this value.</p>
